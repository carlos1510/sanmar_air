                            ...
                            <div class="col-md-3">
                                <div class="mb-3 position-relative">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input class="form-control " type="text" id="fecha_nacimientotxt" maxlength="10" autocomplete="off" placeholder="dd/mm/yyyy" ng-model="registro.fecha_nacimiento" ng-change="calcularEdadActual()" ng-blur="calcularEdadActual()">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
